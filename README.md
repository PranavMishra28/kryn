...
Direct client deployment refuses to pair new client files with a different configured OpenCode plugin path. Rerun the verified package installer from **First installation** to update both transactionally.
