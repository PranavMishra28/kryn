...
FILES = ["LICENSE", "THIRD_PARTY_NOTICES.md", "install-kryn.py",
    ...
    "tools/kryn_plugin.mjs", "tools/run_native_trial.py", "tools/browser_check.mjs",
...
def stage(root, destination, revision, dirty=False):
    ...
    manifest = {"schema": 1, "version": "0.1.1", "source_revision": revision, "source_dirty": dirty, "files": files}
...
def main():
    ...
    wheel = output / "kryn-0.1.1-py3-none-any.whl"
